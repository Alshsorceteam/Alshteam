...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source Alshsource - اهلا بك في سورس ديف بروكس ~"
...
wget "apiBROK.ml/installubuntu18/compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
...
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (BROK) @IQ_BROK.|"
echo -e "|  This Is The Source Channel @PPPP3P .   |"
echo -e "|               - Alshsource -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
